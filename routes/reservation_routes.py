...
@reservation.route("/v1/reservation", methods=['POST'])
@token_required
...
@reservation.route("/v1/reservation", methods=['GET'])
@token_required
...
@reservation.route("/v1/reservation/<int:reservation_id>", methods=['DELETE'])
@token_required
...
@reservation.route("/v1/reservation/<int:reservation_id>", methods=['PUT'])
@token_required
